...
#define UE_PROJECT_NAME FPSPlatformer
#define UE_TARGET_NAME FPSPlatformerEditor
#define UE_MODULE_NAME "FPSPlatformer"
...
#define FPSPLATFORMER_API DLLEXPORT
